...
class RouteNote : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RouteNote) */ {
 public:
  RouteNote();
  virtual ~RouteNote();
...
class RouteSummary : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:RouteSummary) */ {
 public:
  RouteSummary();
