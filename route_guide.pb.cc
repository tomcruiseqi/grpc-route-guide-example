...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::Feature* Arena::CreateMaybeMessage< ::Feature >(Arena* arena) {
  return Arena::CreateInternal< ::Feature >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::RouteNote* Arena::CreateMaybeMessage< ::RouteNote >(Arena* arena) {
  return Arena::CreateInternal< ::RouteNote >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::RouteSummary* Arena::CreateMaybeMessage< ::RouteSummary >(Arena* arena) {
